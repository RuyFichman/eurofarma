...
- **Chatbot:** menu, perguntas frequentes, elegibilidade, orientação, cadastro opcional, retomada por status e ativação ou cancelamento de lembretes estão implementados localmente. Para o handoff futuro, a nutriz deverá pedi-lo explicitamente, a conversa continuará no mesmo chat, o bot será pausado e um atendente do Lactare assumirá entre 9h e 18h, de segunda a sábado; fila, prazo e tratamento fora do horário ainda serão detalhados. Avisos de status e lembretes têm consentimentos opcionais separados. Ainda faltam vídeo institucional oficial, job e envio de lembretes, retirada e reconcessão dos avisos de status, handoff humano operacional e pós-doação baseado em confirmação legítima. Não há conta Meta, número, templates ou URL pública para a entrega real.
