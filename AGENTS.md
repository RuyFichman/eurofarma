...
- **WhatsApp Cloud API / chatbot** — decidido (seção 13), **nada implementado ainda**. Não há app na Meta, número de teste, template nem webhook. A Sprint 6.1 só preparou o schema.
- **Login de nutriz** — decidido (email + senha), **nada implementado**. Hoje `authUserId` existe na tabela e está nulo em todo mundo.
